#
#  Be sure to run `pod spec lint SkyWayRoom.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.source           = {
    :http => 'https://github.com/skyway/ios-sdk/releases/download/1.8.6/SkyWayRoom.xcframework.zip',
  ...
  spec.dependency "SkyWayCore", "1.7.6"
  spec.dependency "SkyWaySFUBot", "1.1.13"
