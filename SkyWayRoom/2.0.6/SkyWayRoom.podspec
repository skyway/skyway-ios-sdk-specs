...
Pod::Spec.new do |spec|
  ...
  spec.source           = {
    :http => 'https://github.com/skyway/ios-sdk/releases/download/2.0.6/SkyWayRoom.xcframework.zip',
  ...
  spec.dependency "SkyWayCore", "2.0.6"
  spec.dependency "SkyWaySFUBot", "2.0.6"
