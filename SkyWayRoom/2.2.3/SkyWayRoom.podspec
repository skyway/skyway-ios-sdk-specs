...
Pod::Spec.new do |spec|
  ...
  spec.source           = {
    :http => 'https://github.com/skyway/ios-sdk/releases/download/2.2.3/SkyWayRoom.xcframework.zip',
  ...
  spec.dependency "SkyWayCore", "2.2.3"
  spec.dependency "SkyWaySFUBot", "2.2.3"
