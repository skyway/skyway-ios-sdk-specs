...
Pod::Spec.new do |spec|
  ...
  spec.source           = {
    :http => 'https://github.com/skyway/ios-sdk/releases/download/1.5.0/SkyWayRoom.xcframework.zip',
  ...
  spec.dependency "SkyWayCore", "1.4.0"
  spec.dependency "SkyWaySFUBot", "1.1.2"
