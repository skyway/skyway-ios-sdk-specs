...
Pod::Spec.new do |spec|
  ...
  spec.source           = {
    :http => 'https://github.com/skyway/ios-sdk/releases/download/1.8.4/SkyWayRoom.xcframework.zip',
  ...
  spec.dependency "SkyWayCore", "1.7.4"
  spec.dependency "SkyWaySFUBot", "1.1.11"
