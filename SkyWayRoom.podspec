...
Pod::Spec.new do |spec|
  ...
  spec.source           = {
    :http => 'https://github.com/skyway/ios-sdk/releases/download/2.1.7/SkyWayRoom.xcframework.zip',
  ...
  spec.dependency "SkyWayCore", "2.1.7"
  spec.dependency "SkyWaySFUBot", "2.1.7"
