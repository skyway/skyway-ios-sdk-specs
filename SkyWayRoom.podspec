...
Pod::Spec.new do |spec|
  ...
  spec.source           = {
    :http => 'https://github.com/skyway/ios-sdk/releases/download/1.6.1/SkyWayRoom.xcframework.zip',
  ...
  spec.dependency "SkyWayCore", "1.5.1"
  spec.dependency "SkyWaySFUBot", "1.1.4"
