...
Pod::Spec.new do |spec|
  ...
  spec.source           = {
    :http => 'https://github.com/skyway/ios-sdk/releases/download/1.4.1/SkyWayRoom.xcframework.zip',
  ...
  spec.dependency "SkyWayCore", "1.3.2"
  spec.dependency "SkyWaySFUBot", "1.1.1"
