...
Pod::Spec.new do |spec|
  ...
  spec.source           = {
    :http => 'https://github.com/skyway/ios-sdk/releases/download/1.4.0/SkyWayRoom.xcframework.zip',
  ...
  spec.dependency "SkyWayCore", "1.3.1"
  spec.dependency "SkyWaySFUBot", "1.1.0"
